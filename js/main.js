jQuery(document).ready(function($) {
   ...
   jQuery('.tp-banner').show().revolution(
    ...
    $('#countdown').countdown({until: new Date(2018, 4-1, 30)}); // enter event day 
	...
	var latlng = new google.maps.LatLng(-7.954118, 112.618640);
	...
	var marker1 = new google.maps.Marker({
		position: new google.maps.LatLng(-7.954118, 112.618640), 
		map: map,		
	...
	var infowindow1 = new google.maps.InfoWindow({  
		content:  createInfo('Invitania', 'Jl. Mayjend Panjaitan 17C<br />Malang, Indonesia, 13247,<br />+62 857 3679 1297<br /><br />')
	}); 
